...
Hides any teleport destinations you pick from the Portal Nexus list in your house. 
...
- **Better Teleport Menu**: hidden rows are disarmed for its keyboard handling as well. But a
  *custom* hotkey you assigned in that plugin is stored by destination name and will still work.
